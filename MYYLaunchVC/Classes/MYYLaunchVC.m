...
//  MYYLaunchVC
//
//  Created by MYY on 2021/3/2.
//

#import "MYYLaunchVC.h"
...
#define kMYYSCREEN_MY_WIDTH(a)        (a) * [[UIScreen mainScreen] bounds].size.width / 375.0
#define kMYYSCREEN_MY_HEIGHT(a)       (a) * [[UIScreen mainScreen] bounds].size.height / 667.0

@interface MYYLaunchVC ()<UIScrollViewDelegate>
/** 播放完成或点击完成按钮的回调 */
...
- (UIButton *)setupEnterButtonInView:(UIView *)view {
    ...
    button.backgroundColor = [UIColor colorWithRed:64/255.0 green:161/255.0 blue:244/255.0 alpha:1];
    ...
    [button mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        if (@available(iOS 11.0, *)) {
            make.bottom.mas_equalTo(self.view.mas_safeAreaLayoutGuideBottom).offset(-kMYYSCREEN_MY_HEIGHT(25));
        } else {
            // Fallback on earlier versions
              make.bottom.mas_equalTo(self.view.mas_bottom).offset(-kMYYSCREEN_MY_HEIGHT(25));
        }
        
        make.right.mas_equalTo(self.view.mas_right).offset(-kMYYSCREEN_MY_WIDTH(20));
        make.width.mas_equalTo(kMYYSCREEN_MY_WIDTH(100));
        make.height.mas_equalTo(kMYYSCREEN_MY_HEIGHT(40));
...
- (UIPageControl *)setupPageControl {
    ...
    [pageControl mas_makeConstraints:^(MASConstraintMaker *make) {
        if (@available(iOS 11.0, *)) {
            make.bottom.mas_equalTo(self.view.mas_safeAreaLayoutGuideBottom).offset(-kMYYSCREEN_MY_HEIGHT(20));
        } else {
            // Fallback on earlier versions
              make.bottom.mas_equalTo(self.view.mas_bottom).offset(-kMYYSCREEN_MY_HEIGHT(20));
        }
